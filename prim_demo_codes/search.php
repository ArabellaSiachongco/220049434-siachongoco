...
<body>
    ...
    if (isset($_GET['query'])) {
        ...
        $username = "u0_a313"; // Replace with your database username
        $password = "4869"; // Replace with your database password
        $dbname = "search_db"; // The database we created earlier
        $socket = '/data/data/com.termux/files/usr/var/run/mysqld/mysqld.sock'; // Specify the socket
